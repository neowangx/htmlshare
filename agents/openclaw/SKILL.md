...
OpenClaw basis: no local version command was available on 2026-07-04, but ~/.openclaw/skills is present and uses SKILL.md skill folders; install.sh symlinks this skill into ~/.openclaw/skills/htmlshare.
